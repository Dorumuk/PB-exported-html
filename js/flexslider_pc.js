...
(function ($) {
  ...
  //flexslider_pc: Object Instance
  $.flexslider_pc = function(el, options) {
    var slider = $(el);

    // making variables public
    slider.vars = $.extend({}, $.flexslider_pc.defaults, options);

    var namespace = slider.vars.namespace,
        msGesture = window.navigator && window.MSGesture,
        touch = (( "onmousedown" in window ) || msGesture || window.DocumentTouch && document instanceof DocumentTouch) && slider.vars.touch,
        // depricating this idea, as devices are being released with both of these events
        eventType = "click mouseleave mouseup MSPointerUp keyup",
        watchedEvent = "",
    ...
    methods = {
      init: function() {
        ...
        // TOUCH
        if (slider.vars.touch) { methods.touch();console.log("istouch"); }
      ...
      controlNav: {
        ...
        setupPaging: function() {
          ...
          if (slider.pagingCount > 1) {
            for (var i = 0; i < slider.pagingCount; i++) {
              ...
              item = (slider.vars.controlNav === "thumbnails") ? '<img src="' + slide.attr( 'data-thumb' ) + '"' + altText + '/>' : '<a role="button" href="#">' + j + '</a>';
        ...
        update: function(action, pos) {
          if (slider.pagingCount > 1 && action === "add") {
            slider.controlNavScaffold.append($('<li><a role="button" href="#">' + slider.count + '</a></li>'));
      ...
      pausePlay: {
        setup: function() {
          var pausePlayScaffold = $('<div class="' + namespace + 'pauseplay"><a role="button" href="#"></a></div>');
        ...
        if(!msGesture){
            onmousedown = function(e) {
              ...
              if (slider.animating) {
                ...
                el.addEventListener('mouseup', onmouseleave, false);
              }
            };
            ...
            onmousemove = function(e) {
              ...
              localY = e.pageY;
                ...
                console.log("onmousemove :: "+localX);
            ...
            onmouseleave = function(e) {
              ...
              el.removeEventListener('mouseleave', onmouseup, false);
  ...
  $.fn.flexslider_pc = function(options) {
    ...
    if (typeof options === "object") {
      ...
      if ( ( $slides.length === 1 && options.allowOneSlide === false ) || $slides.length === 0 ) {
          ...
          new $.flexslider_pc(this, options);
        }
      });
    } else {
